...
const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto">
      ...
      {/* Export MCP Settings */}
      <PermissionChecker permissions={PERMISSIONS.SETTINGS_EXPORT_CONFIG}>
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg py-4 px-6 mb-6 dashboard-card">
          <div
            className="flex justify-between items-center cursor-pointer"
            onClick={() => toggleSection('exportConfig')}
          >
            <h2 className="font-semibold text-gray-800 dark:text-white">{t('settings.exportMcpSettings')}</h2>
            <span className="text-gray-500 dark:text-gray-400">{sectionsVisible.exportConfig ? '▼' : '►'}</span>
          </div>
          ...
          {sectionsVisible.exportConfig && (
            <div className="space-y-4 mt-4">
              <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded-md">
                <div className="mb-4">
                  <h3 className="font-medium text-gray-700 dark:text-gray-300">{t('settings.mcpSettingsJson')}</h3>
