...
const PromptCard = ({ prompt, server, onToggle, onDescriptionUpdate }: PromptCardProps) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow rounded-lg mb-4 overflow-hidden">
      <div
        className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-3 sm:p-2 cursor-pointer gap-3 sm:gap-4"
      ...
      >
        <div className="flex-1 min-w-0 w-full">
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
            ...
            {prompt.title && (
              <span className="text-xs sm:text-sm font-normal text-gray-600 bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded">
                {prompt.title}
              </span>
            )}
